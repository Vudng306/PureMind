const PATHS = {
  ...
  gear: (
    <>
      ...
      <path d="M10.4 2.6h3.2l.4 2.2 1.7 1 2.1-.8 1.6 2.8-1.7 1.5v1.4l1.7 1.5-1.6 2.8-2.1-.8-1.7 1-.4 2.2h-3.2l-.4-2.2-1.7-1-2.1.8-1.6-2.8L6.3 11V9.6L4.6 8.1l1.6-2.8 2.1.8 1.7-1z" />
    </>
  ),
